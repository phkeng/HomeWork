    ...
    <body>
        ...
        <div class="page-left">
                ...
                <p>
                    <%
                        JspUtils.fromInputStream2JspWriter(
                                request.getServletContext().getResourceAsStream("/" + example + "/description.html"),
                                out
                        );
                    %>
                </p>
            ...
            <code class="html">
                        <%
                            JspUtils.fromInputStream2JspWriter(
                                    request.getServletContext().getResourceAsStream("/" + example + "/code.html"),
                                    out
                            );
                        %>
            </code>
        ...
        <div class="page-right">
            <div>example</div>
            <iframe src="<%= example + "/code.html"%>"></iframe>
        </div>
        <div class="clear"></div>
    </body>
</html>
